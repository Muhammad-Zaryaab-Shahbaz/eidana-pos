...
export class CatalogService {
  ...
  GetSettingsById(id: number): Observable<SettingsVM> {
    return this.http
      .get<SettingsVM>(Globals.BASE_API_URL + 'Settings/' + id)
      .pipe();
  }
  SearchSettings(value: SettingsVM): Observable<SettingsVM[]> {
    return this.http
      .post<SettingsVM[]>(Globals.BASE_API_URL + 'Settings/Search', value)
      .pipe();
  }
  GetSettings(): Observable<SettingsVM[]> {
    return this.http
      .get<SettingsVM[]>(Globals.BASE_API_URL + 'Settings')
      .pipe();
  }
  ...
  SearchStngByCode(Id: number, KeyCode: string): Observable<SettingsVM[]> {
    return this.http
      .get<SettingsVM[]>(
        Globals.BASE_API_URL + 'Settings/' + Id + '/' + KeyCode
      )
      .pipe();
  }
  ...
  GetSettingsTypeById(id: number): Observable<SettingsTypeVM> {
    return this.http
      .get<SettingsTypeVM>(Globals.BASE_API_URL + 'SettingsType/' + id)
      .pipe();
  }
  SearchSettingsType(value: SettingsTypeVM): Observable<SettingsTypeVM[]> {
    return this.http
      .post<SettingsTypeVM[]>(
        Globals.BASE_API_URL + 'SettingsType/Search',
        value
      )
      .pipe();
  }
  GetSettingsType(): Observable<SettingsTypeVM[]> {
    return this.http
      .get<SettingsTypeVM[]>(Globals.BASE_API_URL + 'SettingsType')
      .pipe();
  }
  ...
  GetSettingsvById(id: number): Observable<SettingsvVM> {
    return this.http
      .get<SettingsvVM>(Globals.BASE_API_URL + 'Settings/' + id)
      .pipe();
  }
  SearchSettingsv(value: SettingsVM): Observable<SettingsvVM[]> {
    return this.http
      .post<SettingsvVM[]>(Globals.BASE_API_URL + 'Settings/Search', value)
      .pipe();
  }
  GetSettingsv(): Observable<SettingsvVM[]> {
    return this.http
      .get<SettingsvVM[]>(Globals.BASE_API_URL + 'Settings')
      .pipe();
  }
  ...
  GetSettingsvTypeById(id: number): Observable<SettingsvVM> {
    return this.http
      .get<SettingsvVM>(Globals.BASE_API_URL + 'SettingsType/' + id)
      .pipe();
  }
  SearchSettingsvType(value: SettingsTypeVM): Observable<SettingsvVM[]> {
    return this.http
      .post<SettingsvVM[]>(Globals.BASE_API_URL + 'SettingsType/Search', value)
      .pipe();
  }
  GetSettingsvtpe(): Observable<SettingsvVM[]> {
    return this.http
      .get<SettingsvVM[]>(Globals.BASE_API_URL + 'SettingsType')
      .pipe();
  }
